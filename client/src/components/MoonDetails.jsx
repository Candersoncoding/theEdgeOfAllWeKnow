            ...
            <div className="jumbotron bg-dark text-light m-3 p-3 rounded">
                ...
                <div className='d-flex justify-content-start'>
                    <ul className=''>
                        ...
                        {currentMoon.sideralOrbit < 0 ? <p className="lead">sideral orbit: (retrograde) {currentMoon.sideralOrbit} Earth days</p> : <p className="lead">sideral orbit: {currentMoon.sideralOrbit} Earth days</p> }
